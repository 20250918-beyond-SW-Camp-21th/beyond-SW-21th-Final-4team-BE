...
public class EmployerProfileController {
    ...
    @GetMapping
    public ApiResponse<EmployerProfileResponseDto> getProfile(@AuthenticationPrincipal String userId) {
    ...
    @PostMapping("/logo")
    public ApiResponse<String> uploadLogo(@AuthenticationPrincipal String userId,
