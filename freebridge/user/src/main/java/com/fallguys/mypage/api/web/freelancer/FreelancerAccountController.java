...
import com.fallguys.mypage.dto.freelancer.request.UpdatePasswordRequestDto;
...
public class FreelancerAccountController {
    ...
    public ApiResponse<FreelancerNotificationSettingsDto> getNotifications(@AuthenticationPrincipal String userId) {
        return ApiResponse.ok(null);
    }

    @Operation(summary = "알림 설정 수정", description = "프리랜서 알림 수신 여부를 변경합니다.")
    @PutMapping("/notifications")
    public ApiResponse<Void> updateNotifications(@AuthenticationPrincipal String userId,
