...
public class FreelancerProfileController {
    ...
    @GetMapping
    public ApiResponse<FreelancerProfileResponseDto> getProfile(@AuthenticationPrincipal String userId) {
        return ApiResponse.ok(null);
    }

    @Operation(summary = "프리랜서 프로필 수정", description = "직무, 소개, 스킬 등 프로필 정보를 수정합니다.")
    @PutMapping
    public ApiResponse<Void> updateProfile(@AuthenticationPrincipal String userId,
    ...
    @PostMapping("/avatar")
    public ApiResponse<String> uploadAvatar(@AuthenticationPrincipal String userId,
