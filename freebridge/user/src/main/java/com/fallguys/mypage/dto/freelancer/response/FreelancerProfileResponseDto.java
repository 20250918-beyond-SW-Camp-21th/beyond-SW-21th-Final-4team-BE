...
public record FreelancerProfileResponseDto(
    ...
    public FreelancerProfileResponseDto {
        crmAlerts = (crmAlerts == null)
                ? FreelancerCrmAlertsDto.defaultValue()
                : crmAlerts;
    }
    ...
    public record FreelancerCrmAlertsDto(
        ...
        public static FreelancerCrmAlertsDto defaultValue() {
            return new FreelancerCrmAlertsDto(false);
        }
    }
