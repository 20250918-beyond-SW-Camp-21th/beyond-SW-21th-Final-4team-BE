...
public class Freelancer {
    ...
    public void updateBasicProfile(String job, String avatarUrl, String introduction) {
        ...
        if (introduction != null)
            this.introduction = introduction; // 길이 제한은 컨트롤러/검증에서 추가 가능
    }
    ...
    public void updateWorkConditions(WorkConditions workConditions) {
        if (workConditions == null)
            throw new IllegalArgumentException("workConditions is required");
    ...
    public void updateCollaboration(Collaboration collaboration) {
        if (collaboration == null)
            throw new IllegalArgumentException("collaboration is required");
        this.collaboration = collaboration;
    }

    public void updatePortfolioInfo(PortfolioInfo portfolioInfo) {
        if (portfolioInfo == null)
            throw new IllegalArgumentException("portfolioInfo is required");
    ...
    public void updateNotificationSettings(Boolean requestNotificationEnabled, Boolean contractNotificationEnabled) {
        if (requestNotificationEnabled != null)
            this.requestNotificationEnabled = requestNotificationEnabled;
        if (contractNotificationEnabled != null)
            this.contractNotificationEnabled = contractNotificationEnabled;
    }
    ...
    public void removeSkill(String skill) {
        String normalized = normalizeSkill(skill);
        if (normalized == null || this.skills == null)
            return;
