...
public interface EmployerRepository extends JpaRepository<Employer, Long> {
        ...
        List<Employer> findByPendingSubscriptionIsNotNullAndPlanChangeEffectiveDateLessThanEqual(
                        LocalDateTime effectiveDate);

        List<Employer> findByNextBillingDateLessThanEqualAndBillingKeyIsNotNull(LocalDateTime billingDate);

        Page<Employer> findByNextBillingDateLessThanEqualAndBillingKeyIsNotNull(LocalDateTime billingDate,
                        Pageable pageable);
}
