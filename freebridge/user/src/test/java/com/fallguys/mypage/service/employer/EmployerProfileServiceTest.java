...
class EmployerProfileServiceTest {
        ...
        void verify_profile_update_mapping_and_interaction() {
                ...
                com.fallguys.mypage.api.web.dto.employer.request.EmployerProfileUpdateRequestDto requestDto = new com.fallguys.mypage.api.web.dto.employer.request.EmployerProfileUpdateRequestDto(
                                "New Company",
                                "FinTech",
                                "S30_99",
                                "Yeouido",
        ...
        void verify_logo_upload_and_update_interaction() throws java.io.IOException {
                ...
                given(fileStorage.upload(
                                ...
                                org.mockito.ArgumentMatchers.eq("image/png"))).willReturn(uploadedS3Url);
        ...
        void verify_crm_alerts_based_on_subscription() {
                ...
                // when
                com.fallguys.mypage.api.web.dto.employer.response.CrmAlertsResponseDto result = employerProfileService
                                .getCrmAlerts(userId);
